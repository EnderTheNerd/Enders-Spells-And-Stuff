...
public class BigFlurryRenderer extends EntityRenderer<BigFlurryProjectile> {
    private static final ResourceLocation[] TEXTURE = {
            ResourceLocation.fromNamespaceAndPath(endersequipment.MOD_ID, "textures/entity/spells/big_flurry.png")
    };


    public BigFlurryRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(BigFlurryProjectile wave, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull BigFlurryProjectile bigFlurryProjectile) {
        int frame = 0;
    ...
    private void createSlashTexture(PoseStack.Pose pose, BigFlurryProjectile wave, MultiBufferSource bufferSource, float width)
    {
