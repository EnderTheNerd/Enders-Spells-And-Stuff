...
public class PaleFlame40 extends PaleFlame {

    private static final EntityDataAccessor<Boolean> DATA_MIRRORED = SynchedEntityData.defineId(PaleFlame40.class, EntityDataSerializers.BOOLEAN);

    public PaleFlame40(EntityType<? extends Projectile> pEntityType, Level pLevel) {
    ...
    public PaleFlame40(Level level, boolean mirrored) {
        this(EntityRegistry.PALE_FLAME_40.get(), level);
        if (mirrored) {
