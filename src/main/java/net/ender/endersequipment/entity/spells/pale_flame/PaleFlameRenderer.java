...
public class PaleFlameRenderer extends EntityRenderer<PaleFlame> {
    private static final ResourceLocation[] TEXTURES = {
            ResourceLocation.fromNamespaceAndPath(endersequipment.MOD_ID, "textures/entity/spells/pale_flame/pale_flame_1.png"),
            ResourceLocation.fromNamespaceAndPath(endersequipment.MOD_ID,"textures/entity/spells/pale_flame/pale_flame_2.png"),
            ResourceLocation.fromNamespaceAndPath(endersequipment.MOD_ID,"textures/entity/spells/pale_flame/pale_flame_3.png"),
            ResourceLocation.fromNamespaceAndPath(endersequipment.MOD_ID, "textures/entity/spells/pale_flame/pale_flame_4.png")
    };

    public PaleFlameRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(PaleFlame entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    private void drawFlame(PoseStack.Pose pose, PaleFlame entity, MultiBufferSource bufferSource, float width, boolean mirrored) {
    ...
    @Override
    public ResourceLocation getTextureLocation(PaleFlame entity) {
