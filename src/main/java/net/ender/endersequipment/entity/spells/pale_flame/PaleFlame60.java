...
public class PaleFlame60  extends PaleFlame {

    private static final EntityDataAccessor<Boolean> DATA_MIRRORED = SynchedEntityData.defineId(PaleFlame60.class, EntityDataSerializers.BOOLEAN);
    ...
    public PaleFlame60(Level level, boolean mirrored) {
        this(EntityRegistry.PALE_FLAME_60.get(), level);
        if (mirrored) {
