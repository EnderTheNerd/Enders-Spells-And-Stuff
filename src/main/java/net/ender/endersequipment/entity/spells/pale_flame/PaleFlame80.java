...
public class PaleFlame80  extends PaleFlame {

    private static final EntityDataAccessor<Boolean> DATA_MIRRORED = SynchedEntityData.defineId(PaleFlame80.class, EntityDataSerializers.BOOLEAN);

    public PaleFlame80(EntityType<? extends Projectile> pEntityType, Level pLevel) {
    ...
    public PaleFlame80(Level level, boolean mirrored) {
        this(EntityRegistry.PALE_FLAME_80.get(), level);
        if (mirrored) {
