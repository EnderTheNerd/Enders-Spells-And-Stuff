...
@AutoSpellConfig
public class ImpulseSpell extends AbstractPrimevalSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(endersequipment.MOD_ID, "impulse");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        MagicManager.spawnParticles(level, ParticleHelper.ELECTRIC_SPARKS, entity.getX(), entity.getY() + 1, entity.getZ(), 80, .25, .25, .25, 0.7f + radius * .1f, false);
        CameraShakeManager.addCameraShake(new CameraShakeData(25, entity.position(), radius * 3));
        ...
        dummyLightningBolt.setDamage(10);
        dummyLightningBolt.setVisualOnly(false);
    ...
    public float getRadius(int spellLevel, LivingEntity caster) {
        return 19 + spellLevel;
    }

    public float getDamage(int spellLevel, LivingEntity caster) {
        return 4 + (getSpellPower(spellLevel, caster) * 2f);
    }
