...
@AutoSpellConfig
public class ArrowCloudSpell extends AbstractPrimevalSpell {

    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(endersequipment.MOD_ID, "archers_paradise");
    ...
    public ArrowCloudSpell() {
        this.manaCostPerLevel = 0;
        this.baseSpellPower = 25;
        this.spellPowerPerLevel = 1;
        this.castTime = 50;
        this.baseManaCost = 190;
    }
